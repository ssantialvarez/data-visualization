...
const CharacterCard: React.FC<CharacterCardProps> = ({ image, name, id, tvShows, films, shortFilms, videogames }) => {
    ...
    return (
        <>
            <div className="bg-white opacity-95 shadow-lg rounded-2xl overflow-hidden p-4 w-72 h-full flex flex-col justify-between relative hover:opacity-100 transition-opacity">
